...
import { getEquipeById, addJoueurNBA, getEquipesByLigue, getEquipesByLigueAndByDraft, getEquipeByLigueAndUser, removeJoueurNBA, replaceJoueurNBA, updateScoreEquipe, getHistorique, getEquipesByUtilisateur, createEquipe, getEquipeByLigueAndUserAndDraft } from "../controllers/equipeController";
...
router.get("/byLigueAndByDraft/:ligue_id/:draft_id", getEquipesByLigueAndByDraft);
